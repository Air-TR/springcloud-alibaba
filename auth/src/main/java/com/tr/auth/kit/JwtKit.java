...
public class JwtKit {
    ...
    public static String getToken() {
        return HttpKit.getTokenFromHeader(((ServletRequestAttributes) Objects.requireNonNull(RequestContextHolder.getRequestAttributes())).getRequest());
    }
    ...
    public static SecretKey generalKey() {
        byte[] encodedKey = Base64.getDecoder().decode(JwtKit.JWT_KEY);
